$(document).ready(function() {
  ...
  var description = [];
  description.push('You come from humble beginnings but dream of finding your true self. You may fall in with the wrong crowd but good friends and love from family will keep you grounded. You are an honest and brave individual.');
  description.push('You are a romantic at heart. Family is very important to you and you are fiercely protective of those you care about. You have empathy for others and do not let society dictate who you associate with.');
  description.push('You have a gentle soul and believe that cleanliness is close to godliness. Some may be jealous of the attention you get, but you are a popular person who has many guy friends. Keep on being happy-go-lucky!');
